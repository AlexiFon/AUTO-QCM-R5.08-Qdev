"""
Django settings for auto_qcm project.
...
SECRET_KEY = "django-insecure-1q^v8j#uly@uivps+p0!9wm@++ddp!wr!=chd*^q(ves!*4y=1"
...
WSGI_APPLICATION = "auto_qcm.wsgi.application"
